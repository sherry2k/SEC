...
// Just the document content — no letterhead, no footer. Used two ways:
// wrapped in PrintDocumentShell for the normal in-app view/print (where
// the shell's <thead>/<tfoot> table trick handles repeating branding),
// and standalone on the dedicated /print/... page that the server-side
// PDF generator loads, where Puppeteer supplies the header/footer itself.
export default function QuotationPrintBody({ quotation }: { quotation: PrintableQuotation }) {
